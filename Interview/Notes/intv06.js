...
// greet.call(person1, 'Hello'); // Output: Hello, John! You are 30 years old.
// greet.call(person2, 'Hi');    // Output: Hi, Alice! You are 25 years old.
...
// const person = { name: 'Emma', age: 35 };

// function introduce(prefix, suffix) {
//     console.log(`${prefix} ${this.name}, ${suffix}.`);
// }

// introduce.apply(person, ['My name is', 'Nice to meet you']); 
// Output: My name is Emma, Nice to meet you.
...
//  bind: The bind method creates a new function with a specified this value and initial arguments.
//  EX:
// const cat = { name: 'Whiskers' };

// function greetOwner(greeting) {
//     console.log(`${greeting}, ${this.name}!`);
// }

// const greetCat = greetOwner.bind(cat);
// greetCat('Meow'); // Output: Meow, Whiskers!
