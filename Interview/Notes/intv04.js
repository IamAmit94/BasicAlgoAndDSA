...
const func = (function(a) {
    delete a; // since delete is not applied for the local variable
    return a;
})(5);
...
const obj = {
    a: "one",
    b: "two",
    a: "three", // will update the latest key
}
...
// console.log(a) // [object, object] = 456 ||bcz object can not be converted to the string
console.log(a[b]) // 456
...
const obj2 = JSON.parse(jsonString1);
console.log(obj2); // Output: { name: "John", age: 30 }



// JSON.stringify converts a JavaScript object into a JSON string, while JSON.parse converts a JSON string back into
//  a JavaScript object. These functions are complementary and are often used together when working with JSON data 
...
e.greeting = "Hello";
console.log(d.greeting); // Hello || becz we are not copying the value of variable we are providing the ref to the
//  variable
...
// SHALLOW COPY: When we copy the 1 obj to another obj. And it hold the refrence of the another obj this is called
//  the shallow copy
const userMe = { 
    name: 'Beta',
    age : 0
...
// const objClone = Object.assign({}, userMe); // using the Object.assign
// const objClone = JSON.parse(JSON.stringify(userMe)); // using json.parse and stringify
const objClone = {...userMe} // destructure
objClone.name = "Theta"
