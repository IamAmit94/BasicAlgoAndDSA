...
// The above output is because js execute the synchronous code first. Async operation
// always run after the complete execution of the sync code
...
//     return "Error Caught"    // Errorr Caught || this is resolved promise
// })
// .then(function (data) {
//     console.log(data); 
...
// create the firstPromise which will resolve to 'first!' and then create the secondPromise
// which will resolve the firstPromise and it will return the result of secondPromise
