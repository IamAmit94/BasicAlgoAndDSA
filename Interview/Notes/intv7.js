...
// Debouncing is a technique that delays the execution of a function until after a specified time period has elapsed since the last invocation of the function. It is commonly used to handle events that may fire rapidly, such as keystrokes in a search input or scroll events. With debouncing, the function will only be executed once, after a certain period of inactivity, even if it is called multiple times during that period.
